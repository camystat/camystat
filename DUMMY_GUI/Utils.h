...
public:
    ...
    static void plotVector(const std::vector<double> values, const std::string name, int min, int max);
    static std::vector<double> aggregate(std::string videoPath, std::string compressedPath, std::string heatmapPath, std::string coordPath, std::string resultPath);
    static std::vector<double> normalize_values(const std::vector<double>& values);
    ...
    static void callPlotEvents(const std::string& exePath,
        ...
        std::string command = "\"" + exePath + "\" \"" + valuesPath + "\" \"" + eventsPath + "\" \"" + videoName + "\" \"" + savePath + "\" " + std::to_string(fps) + " \"" + pathToRemove + "\" " + std::to_string(normalize_flag);
